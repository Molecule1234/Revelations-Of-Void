...
import net.scar.rotvmod.block.custom.alchemy.AlchemyMachineBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> IMBUED_STONE = registerBlock("imbued_stone",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> ALCHEMY_MACHINE = registerBlock("alchemy_machine",
            () -> new AlchemyMachineBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).noOcclusion()));
